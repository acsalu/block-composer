...
@property (retain) id<SCWaveLayerDelegate> parentView;
- (void) startAnimation;
@end
...
{
	CGContextSetRGBStrokeColor(theContext, 182, 232, 251, 1.0);
...
- (void) spawnWave
{
	...
	wave.shadowColor = [UIColor colorWithRed:182/255 green:232/255 blue:251/255 alpha:1].CGColor;
